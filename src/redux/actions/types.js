...
* Movies views
*/
export const ADD_USER_MOVIE_REQUEST="ADD_USER_MOVIE_REQUEST";
export const ADD_USER_MOVIE_SUCCESS="ADD_USER_MOVIE_SUCCESS";
export const ADD_USER_MOVIE_FAILURE="ADD_USER_MOVIE_FAILURE";
